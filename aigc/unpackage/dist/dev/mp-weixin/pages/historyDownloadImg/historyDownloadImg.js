...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const queryList = async (pageNo, pageSize) => {
      ...
      const res = await common_utils.httpsRequest(`/hh/dialog_dl/pageBy/${pageSize}/${pageNo}`, query, "GET");
    ...
    return (_ctx, _cache) => {
      return {
        ...
        j: common_vendor.sr(paging, "16e12bec-0", {
          "k": "paging"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-16e12bec"], ["__file", "/Users/huyi/Desktop/own-project/aigc/aigcminni/aigc/pages/historyDownloadImg/historyDownloadImg.vue"]]);
